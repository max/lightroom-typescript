...
[![NPM version](https://img.shields.io/npm/v/lightroom.svg)](https://npmjs.org/package/lightroom) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/lightroom)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/lightroom-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install lightroom`
...
```ts
import Lightroom from 'npm:lightroom';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/lightroom-typescript/issues) with questions, bugs, or suggestions.
