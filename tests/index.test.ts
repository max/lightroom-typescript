...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Lightroom({ logger: logger, logLevel: 'info' });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['LIGHTROOM_LOG'] = 'debug';
      const client = new Lightroom({ logger: logger, logLevel: 'off' });
  ...
  describe('defaultQuery', () => {
    ...
    test('overriding with `undefined`', () => {
      const client = new Lightroom({ baseURL: 'http://localhost:5000/', defaultQuery: { hello: 'world' } });
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Lightroom({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Lightroom({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Lightroom({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    afterEach(() => {
      process.env['LIGHTROOM_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Lightroom({ baseURL: 'https://example.com' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['LIGHTROOM_BASE_URL'] = 'https://example.com/from_env';
      const client = new Lightroom({});
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['LIGHTROOM_BASE_URL'] = ''; // empty
      const client = new Lightroom({});
      expect(client.baseURL).toEqual('https://lr.adobe.io/');
    });

    test('blank env variable', () => {
      process.env['LIGHTROOM_BASE_URL'] = '  '; // blank
      const client = new Lightroom({});
      expect(client.baseURL).toEqual('https://lr.adobe.io/');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Lightroom({ maxRetries: 4 });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Lightroom({});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Lightroom({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Lightroom({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Lightroom({ fetch: testFetch });
